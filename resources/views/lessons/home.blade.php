                    ...
                    <ol class="w-full border-2 p-3 border-pink-800">
                        @foreach($announcements as $announcement)
                            ...
                            <li class="flex items-center">
                                ...
                                @if(auth()->user()->admin)
                                    <form action="/{{ $announcement->id }}" id="form_{{ $announcement->id }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="/{{ $announcement->id }}" class="px-2 py-1 text-red-900 border border-red-900 font-semibold rounded hover:bg-red-200">Edit</a>
                                @endif
                            </li>
                        @endforeach
                    </ol>
